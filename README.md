...
- **[validate-mermaid](./skills/engineering/validate-mermaid/SKILL.md)** — Validate Mermaid diagrams in Markdown, MDX, HTML, and standalone files, including recursive directory scans.
...
- **[grill-me](./skills/productivity/grill-me/SKILL.md)** — Stress-test a plan or design through focused questions until the important decisions are explicit.
- **[handoff](./skills/productivity/handoff/SKILL.md)** — Compact the current conversation into a handoff document so another agent can continue the work.
- **[slidev](./skills/productivity/slidev/SKILL.md)** — Build and revise Slidev presentations through narrative beats, animations and interactions, speaker notes, rendered visual review, and build/export validation.
...
- **[grilling](./skills/productivity/grilling/SKILL.md)** — Stress-test a plan, decision, or idea through focused rounds with recommendations and reasons. The reusable questioning primitive behind `grill-me`, `grill-with-docs`, `triage`, `wayfinder` and `improve-codebase-architecture`.
