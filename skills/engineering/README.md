...
- **[grill-with-docs](./grill-with-docs/SKILL.md)** — Stress-test a design through focused questions while sharpening terminology and updating `CONTEXT.md` and ADRs inline.
...
- **[validate-mermaid](./validate-mermaid/SKILL.md)** — Validate Mermaid diagrams in Markdown, MDX, HTML, and standalone files, including recursive directory scans.
